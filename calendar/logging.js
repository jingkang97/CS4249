...
// docs.google.com/forms/d/e/1FAIpQLSf-H0XExwzcCAFtxS1yQi_6q1yzBt2qsmitQUrAiep_oGNphA/viewform
function sendNetworkLog(
    uid,
    technique,
    preference,
    ...
    target,
    retries) {
  var formid = "e/1FAIpQLSf-H0XExwzcCAFtxS1yQi_6q1yzBt2qsmitQUrAiep_oGNphA";
  var data = {
    "entry.291160548": uid,
    "entry.1369922782": technique,
    "entry.1055743175": preference,
    "entry.1339645045": slots,
    "entry.2053817221": time,
    "entry.1106941842": eventname,
    "entry.1060696541": target,
    "entry.555222347": retries
  };
  var params = [];
  for (key in data) {
    params.push(key + "=" + encodeURIComponent(data[key]));
