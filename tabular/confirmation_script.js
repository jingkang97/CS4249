...
const total_session_charge = '$' + ((selected_slots.length * 13.91).toFixed(2)).toString()
document.getElementById("total_session_charge").innerHTML = total_session_charge
document.getElementById("total_session_charge_value").innerHTML = total_session_charge
